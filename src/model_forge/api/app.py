...
from .ports import ModelForgeApplicationService
from .router import create_api_router


def create_app(service: ModelForgeApplicationService) -> FastAPI:
    ...
    app = FastAPI(title="Model Forge API", version="1.0.0", lifespan=lifespan)
    app.state.model_forge_service = service
