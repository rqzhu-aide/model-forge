...
ERROR_RULES: dict[CommandErrorCode, ErrorRule] = {
    "AUTHENTICATION_REQUIRED": ErrorRule("authentication", 401, True, "MF-59"),
    "DELEGATION_NOT_ACTIVE": ErrorRule("authorization", 403, True, "MF-55"),
    "COMMAND_SCHEMA_INVALID": ErrorRule("schema", 422, True, "MF-59"),
    "COMMAND_DIGEST_MISMATCH": ErrorRule("digest", 422, True, "MF-57"),
    "IDEMPOTENCY_KEY_REUSED": ErrorRule("idempotency", 409, True, "MF-49"),
    "INVALID_TRANSITION": ErrorRule("transition", 409, False, "MF-59"),
    "RUN_ALREADY_SUBMITTED": ErrorRule("transition", 409, False, "MF-59"),
    "CANCELLATION_REQUESTED": ErrorRule("concurrency", 409, False, "MF-59"),
    "CONTROL_HEAD_STALE": ErrorRule("concurrency", 409, True, "MF-49"),
    "STALE_BASIS": ErrorRule("concurrency", 409, True, "MF-49"),
    "TARGET_STATE_MISMATCH": ErrorRule("concurrency", 409, True, "MF-49"),
    "TARGET_NOT_FOUND": ErrorRule("dependency", 404, False, "MF-59"),
    "DEPENDENCY_CLOSURE_INCOMPLETE": ErrorRule("dependency", 422, True, "MF-59"),
    "NO_STATE_CHANGE": ErrorRule("transition", 409, False, "MF-47"),
    "PUBLICATION_CONFLICT": ErrorRule("concurrency", 409, True, "MF-56"),
    "CUSTOMIZATION_CONFLICT": ErrorRule("transition", 409, False, "MF-49"),
    "ROLE_PROVISIONING_FAILED": ErrorRule("transition", 500, True, "MF-59"),
    "SUPERVISED_RUN_INVALID": ErrorRule("schema", 400, True, "MF-60"),
    "SUPERVISED_RUN_LOCKED": ErrorRule("concurrency", 409, False, "MF-61"),
    "SUPERVISED_RUN_PREFLIGHT_FAILED": ErrorRule("dependency", 409, True, "MF-62"),
    "CORRECTION_NOT_APPLICABLE": ErrorRule("transition", 409, False, "MF-73"),
    "CORRECTION_SCOPE_INVALID": ErrorRule("schema", 400, True, "MF-74"),
    "CORRECTION_EXHAUSTED": ErrorRule("transition", 409, False, "MF-75"),
}
