...
def _service_from_request(request: Request) -> ModelForgeApplicationService:
    return cast(ModelForgeApplicationService, request.app.state.model_forge_service)


Service = Annotated[ModelForgeApplicationService, Depends(_service_from_request)]
...
async def _capture_and_parse(
    request: Request,
    service: ModelForgeApplicationService,
