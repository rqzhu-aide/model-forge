"""Composition root for the greenfield Model Forge application."""
...
from .service import ModelForgeService
...
def build_service(settings: ApplicationSettings) -> ModelForgeService:
