...
class DomainValidationError(ModelForgeError, ValueError):
...
class JsonLoadError(ModelForgeError, ValueError):
...
class SchemaCatalogError(ModelForgeError):
    """The schema catalog itself is incomplete, ambiguous, or invalid."""


class SchemaValidationError(ModelForgeError, ValueError):
